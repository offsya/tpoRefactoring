            ...
            <div>
                {
                    // chooseWeeks == 3 ?
                    <div>
                        <div style={{position: 'relative', left: '-4px'}} className="calendDaysThreeMobile calendDaysThreeDef">
                            {
                        ...
                        <div className="calendDaysNumbersThreeMobile calendDaysNumbersDef">
                            {

...
const CalendModal = ({setSeeCalend, setCheck}) => {
        ...
        <div className='modal' onClick={() => {dispatch(setCalendOpen(false)); dispatch(setCheckFrstCalendOpen(false))}}>
            <div className='profitModal' onClick={(e) => e.stopPropagation()}>
                ...
                <div className="calendForModal">
                    ...
                    <div className='acceptButtonModal' onClick={() => {dispatch(setCalendOpen(false)); dispatch(setCheckFrstCalendOpen(false))}}>
                        <div>
                            Accept
                        </div>
                    </div>
